...
class ZooKeeper extends EventEmitter {
    ...
    static get ZOO_PERSISTENT() {
        return NativeZk.ZOO_PERSISTENT;
    }
    ...
    /** @deprecated @returns {number} 2 */
    static get ZOO_PERSISTENT_SEQUENTIAL() {
        return NativeZk.ZOO_PERSISTENT_SEQUENTIAL;
    }

    /** @deprecated @returns {number} 3 */
    static get ZOO_EPHEMERAL_SEQUENTIAL() {
        return NativeZk.ZOO_EPHEMERAL_SEQUENTIAL;
    }
